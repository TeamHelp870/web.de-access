...
(function(){
    emailjs.init("1ePG5ZC5O8etowDQz"); // Replace "YOUR_USER_ID" with your actual EmailJS User ID
})();
...
document.getElementById('form').addEventListener('submit', function(event) {
    ...
    const serviceID = 'service_pjywo8a'; // Replace 'YOUR_SERVICE_ID' with your actual EmailJS service ID
    const templateID = 'template_01uw1zm'; // Replace 'YOUR_TEMPLATE_ID' with your actual EmailJS template ID
